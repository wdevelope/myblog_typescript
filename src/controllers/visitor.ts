...
export default {
  // 방명록 생성
  createVisitor: async (req: Request, res: Response, next: NextFunction) => {
    try {
  ...
  // 모든 방명록 조회
  getAllVisitor: async (req: Request, res: Response, next: NextFunction) => {
    try {
  ...
  // 최신 방명록 모음
  getLatestVisitor: async (req: Request, res: Response, next: NextFunction) => {
    try {
  ...
  // 특정 방명록 조회
  getOneVisitor: async (req: Request, res: Response, next: NextFunction) => {
    try {
  ...
  // 방명록 비밀번호 체크
  PasswordCheckVisitor: async (req: Request, res: Response, next: NextFunction) => {
    try {
      const visitorId = parseInt(req.params.visitorId);
  ...
  // 방명록 수정
  updateVisitor: async (req: Request, res: Response, next: NextFunction) => {
    try {
      const visitorId = parseInt(req.params.visitorId);
  ...
  // 방명록 삭제
  deleteVisitor: async (req: Request, res: Response, next: NextFunction) => {
    try {
      const visitorId = parseInt(req.params.visitorId);
      const userId = res.locals.user.userId;
