...
exports.default = {
    createCategory: (name, position) => __awaiter(void 0, void 0, void 0, function* () {
        return yield category_1.default.create({ name, position });
    }),
    ...
    findByNameCategory: (name) => __awaiter(void 0, void 0, void 0, function* () {
        return yield category_1.default.findOne({ where: { name } });
    }),
    updateCategory: (id, name) => __awaiter(void 0, void 0, void 0, function* () {
        const [affectedCount] = yield category_1.default.update({ name }, {
            where: { id },
        });
